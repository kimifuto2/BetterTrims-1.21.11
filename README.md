...
| 下界合金 Netherite | 斩首/火免/甲韧 | 每件 +2 护甲、+1 韧度；穿戴时获得**火焰抗性**；**免疫火焰伤害**，物品不会被烧毁；攻击有概率**追加穿透伤害**并**掉落生物头颅**（凋零骷髅头/骷髅头/僵尸头/苦力怕头/猪灵头） |
...
| 附魔金苹果 | +6/12/16/20 生命上限；每件 **-5% 伤害**（4 件 -20%）；**生命恢复**（仅全套可获，II 级） | ✅ 已实现 |
